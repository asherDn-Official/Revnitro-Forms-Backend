...
router.post("/", async (req, res) => {
  try {
    ...
    const Subject = "Ownership Review Request From RevNitro";
    const content = `
    <!DOCTYPE html>
    <html lang="en">
      <head>
      ...
      <body>
        ...
        <div class="notification-container">
          <p>Vehicle Type : <strong>${details.type}</strong></p>
          <p>Model Name: <strong>${details.model}</strong></p>
          <p>Year Of Make : <strong>${details.year}</strong></p>
          ...
          <p>Slot Date: <strong>${details.slotDate}</strong></p>
          <p>Slot Time: <strong>${details.slotTime}</strong></p>
          <br/>
          <br/>
