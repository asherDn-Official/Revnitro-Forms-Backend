...
router.post("/", async (req, res) => {
  try {
    ...
    const Subject = "Business Collaboration Request From RevNitro";
    const content = `
    <!DOCTYPE html>
    <html lang="en">
      <head>
      ...
      <body>
        ...
        <div class="notification-container">
          ...
          <p>Name: <strong>${details.companyName}</strong></p>
          ...
          <p>Additional Details: <strong>${details.details}</strong></p>
          <br/>
          <br/>
